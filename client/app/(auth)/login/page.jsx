    ...
    <div>
      ...
      <div className='flex justify-center mt-12'>
        <div className='h-130 w-120 rounded-2xl bg-linear-to-b from-blue-300 to-white border-2 px-4 py-4 text-black'>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col gap-6 my-14'>
            <div>
              <label htmlFor="identifier"><h1>Email or Username:</h1></label>
            ...
            <button className='w-60 px-4 py-2 bg-linear-to-r from-blue-500 to-purple-500 text-white rounded-4xl my-8 ml-25 cursor-pointer' disabled={loading}>
