    ...
    <div>
      ...
      <div className='flex justify-center mt-12'>
        <div className='h-130 w-120 rounded-2xl bg-linear-to-b from-blue-300 to-white border-2 px-4 py-4 text-black'>
          ...
          <form action="" className='flex flex-col gap-6 my-8'>
            <div>
              <label htmlFor="username"><h1>Username:</h1></label>
              <input type="username" id='username' placeholder='Enter your username' className='border-gray-500 border-2 rounded-3xl w-full px-2 py-2'/>
            </div>

            <div>
              <label htmlFor="email"><h1>Email:</h1></label>
              <input type="email" id='email' placeholder='Enter your email' className='border-gray-500 border-2 rounded-3xl w-full px-2 py-2'/>
            </div>
